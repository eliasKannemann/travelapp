...
function Hero({ hero: { title, subtitle, btn1, btn2, text, img } }) {
  return (
    <>
      <div className="flex flex-col bg-gradient-to-b from-emerald-200 to-white h-auto w-auto">
        <div className="travelapp-container grid items-start justify-items-center">
          <div className="grid items-center justify-items-center mt-36 mb-16 md:mt-28 md:mb-12">
            <h1 className="text-7xl font-bold lg:text-6xl md:text-4xl sm:text-xl xsm:text-3xl text-black filter drop-shadow-lg">
              {title}
            </h1>
            <h1 className="text-7xl font-bold lg:text-6xl md:text-4xl sm:text-xl xsm:text-3xl text-black filter drop-shadow-lg">
              {subtitle}
          ...
          <div className="flex items-center justify-center mb-11">
            <img
              src={img}
              alt="dashboard/img"
              className="h-[85vh] w-full object-fill lg:h-[75vh] md:h-[57vh] sm:h-[35] sm:object-contain drop-shadow-emerald"
            />
          </div>
        </div>
      </div>
